MESSAGES = {
    "en": {
        ...
        "get_skills": "🤹 Please specify your skills (e.g., Python, SQL, Docker):",
    ...
    "ru": {
        ...
        "get_skills": "🤹 Укажите ваши навыки (например, Python, SQL, Docker):",
    ...
    "zh": {
        ...
        "get_skills": "🤹 请指定你的技能（例如：Python, SQL, Docker）：",
